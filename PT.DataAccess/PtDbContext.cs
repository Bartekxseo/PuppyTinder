...
namespace PT.DataAccess
{
    public class PTDbContext : DbContext
    {
        ...
        public PTDbContext(string connString) : base(connString)
        {
            ...
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<PTDbContext, Migrations.Configuration>());
        ...
        public override int SaveChanges()
        {
            ...
            {
                throw new Exception("PTDbContext.SaveChanges:\n" + ex.Message + "\n" + ex.InnerException?.Message + "\n" + ex.StackTrace, ex);
            }
        }
